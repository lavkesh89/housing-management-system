...
def login_in():
	...
	orionLabel=Label(login_menu, text="HOUSING MANAGMENT SYSTEM",bg='purple',font=("Castellar", "22","bold","underline"),fg="Yellow")
	subLabel=Label(login_menu, text="BY Lavkesh and Aditya",font=("Castellar", "14","bold","italic"))
	...
	loginbutton1=Button(login_menu,command=login_check,text=" Login ",bg='cyan',height='1',width='8', font=k_font,  bd = '5')
	registerbutton=Button(login_menu,command=register_in,text=" Register ",bg='light green',fg='white',height='2',width='11',font=k_font, bd = '5',)
	#feedbackbutton=Button(login_menu,command=feedback_read,text=" Feedback ",bg='yellow',height='2',width='11',font=k_font, bd = '5')
	adminbutton=Button(login_menu,command=admin_in,text=" Admin Login ",bg='orange', fg='white',height='2',width='11',font=k_font, bd = '5')
...
def Admin_Opt():
		...
		addbutton=Button(opt_menu,command=add_book,text=" Update property List",bg='coral',height=1,width=16,font=k_font)
		delbutton=Button(opt_menu,command=del_book,text=" Remove property ",bg='purple',height=1,width=12,font=k_font)
		backbutton=Button(opt_menu,command=reopen_login,text=" Log out ",bg='plum',height=1,width=12,font=k_font)
...
def del_book():
	...
	borrow_list2.configure(background="green")
	borrow_list3.configure(background="green")
	borrow_list.configure(background="light blue")
	borrow_list4.configure(background="dark blue")
...
def del_check():
	...
	if(pos == -1):
		tkinter.messagebox.showinfo("Delete","Property not present.Please re-enter")
		del_menu.destroy()
		return(del_book)
	else:
		f = open ('BData.txt', 'r')
...
def Main_Menu():
	...
	base.wm_title("Lavkesh and Aditya property dealers")
	...
	#Bunch of labels
	status = Label(base,text=("Date and time logged in: " + current_time),bd=1,relief=SUNKEN,anchor=W,bg='red')
	orionLabel=Label(base, text="HOUSING MANAGMENT SYSTEM",bg='Olive',font=("Castellar", "50","bold","underline"),fg="Yellow")
	welcomeLabel=Label(base,text=("Welcome to system for rental or buy:"+id),font=("Freestyle Script","50","bold"))
	...
	#Buttons
	borrow_but=Button(bottomFrame,bg="dark blue",fg="white",text="Buy Property",font=in_font,height=5,width=17,command=borrow_in)
	return_but=Button(bottomFrame,bg="olive",text="Return Property",font=in_font,height=5,width=17,command=return_in)
	search_but=Button(bottomFrame,bg="light blue",fg="white",text="Search for Property",font=in_font,height=5,width=17,command=search_in)
...
def feedback_in():
	...
	feedback_label=Label(feedback_menu,text= "We improve from your valuable feedback.Thank you!",font=("Monotype corsiva","15","italic"),bg="olive")
